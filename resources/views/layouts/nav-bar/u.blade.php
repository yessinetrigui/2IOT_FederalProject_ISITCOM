            ...
            <ul class="items">
                ...
                <li class="item" id="it3">
                    <a href="{{route('user.events')}}">
                        ...
                        @if(url()->current() == route('user.events'))
                        <div class="line" style="width: 100%;"></div>
                        @else
                        <div class="line"></div>
                        @endif                    </a>
                ...
                <li class="item" id="it4">
                    <a href="{{route('user.rules')}}">
                        ...
                        @if(url()->current() == route('user.rules'))
                        <div class="line" style="width: 100%;"></div>
                        @else
                        <div class="line"></div>
                        @endif
                ...
                <li class="item" id="it5">
                    <a href="{{route('user.catalogue')}}">
                        <div class="ico"><img src="{{ URL::to('/assets/icons/mono-kstars-catalog.svg') }}" alt=""></div>
                        <div class="txt">Catalogue</div>
                        @if(url()->current() == route('user.catalogue') ||url()->current() == route('user.cars') ||
                         url()->current() == route('user.motos') || url()->current() == route('user.others')  ||
                                url()->current() == route('user.planes') )
                        <div class="line" style="width: 100%;"></div>
                        @else
                        <div class="line"></div>
                        @endif
